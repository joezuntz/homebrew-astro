...
class Ds9 < Formula
  ...
  if MacOS.version == :snow_leopard
    ...
    url 'http://hea-www.harvard.edu/RD/ds9/download/darwinlion/ds9.darwinlion.7.3b5.tar.gz'
    sha1 '5d7f0448e80298d71d9b0addf717e227c035b297'
  elsif MacOS.version == :mountain_lion
    url 'http://hea-www.harvard.edu/RD/ds9/download/darwinmountainlion/ds9.darwinmountainlion.7.3b5.tar.gz'
    sha1 '3bb2f7d15c8b6f366e7f19c5408acd47800ac18c'
  elsif MacOS.version == :mavericks
    url 'http://hea-www.harvard.edu/RD/ds9/download/darwinmavericks/ds9.darwinmavericks.7.3b5.tar.gz'
